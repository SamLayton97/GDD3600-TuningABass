...
if (currTune < 35 && sprite_index != spr_electronicTunerFlat)
	// set tuner to show pitch as flat
	sprite_index = spr_electronicTunerFlat;
// if pitch is above 'hot zone'
else if (currTune > 65 && sprite_index != spr_electronicTunerSharp)
...
else if (currTune >= 51 && currTune <= 65 && sprite_index != spr_electronicTunerSharpFlashing)
...
else if (currTune >= 35 && currTune <= 49 && sprite_index != spr_electronicTunerFlatFlashing)
